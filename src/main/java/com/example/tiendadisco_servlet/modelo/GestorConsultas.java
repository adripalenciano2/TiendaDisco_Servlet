package com.example.tiendadisco_servlet.modelo;
...
public class GestorConsultas {
    ...
    private void creaFichero(){
        ...
        String nombreFichero = "C:\\Users\\Adri\\tomcat\\ficheroDiscos";
        try {
    ...
    public String bajaDisco(int codigoBuscado) {
        ...
        try{
            ...
            if (disco.getCantidad() == 0){
                stream.seek(0);
                return "Disculpe. No quedan ejemplares de este disco.<br/><br/>" + disco.toString();
            }
            disco.setCantidad(disco.getCantidad()-1);
            String mensaje=disco.toString();
            if(disco.getCantidad()==0)
                mensaje += "<br/><br/>Recuerde que esta era la ultima copia en stock.";
